import { getSalesTrendData, getTopProductsData, getTopProductsByUnitsData, getPeakHoursData } from "@/actions/analytics"
import { DashboardCharts } from "./dashboard-charts"

export async function DashboardChartsContainer({ month, year }: { month?: number, year?: number }) {
    const [trendRes, topProductsRes, topUnitsRes, peakHoursRes] = await Promise.all([
    ...
    return <DashboardCharts salesTrend={trendData || []} topProducts={topProducts || []} topProductsUnits={topProductsUnits || []} peakHours={peakHours || []} />
}
