...
- **React**: 19.2.1+ con Server Components
- **TypeScript**: 5.7+ en modo estricto
- **Supabase**: @supabase/ssr v0.8+ (NUNCA @supabase/auth-helpers-nextjs)
- **Supabase JS**: @supabase/supabase-js latest
- **Tailwind CSS**: v4 (CSS-first config, sin tailwind.config.js)
- **Validación**: Zod
...
- ✅ USA: `proxy.ts` con export function `proxy`
- ❌ NUNCA: `middleware.ts` (deprecado en Next.js 16)
